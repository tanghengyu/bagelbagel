...
from .views import CustomerProfileView, ShoppingCartView,RemoveFromCartView, MerchantIndexView, MerchantOrderView, OrderDetailView, CancelOrderView,MarkNotificationReadView, RateOrderView
app_name = 'customer'
urlpatterns = [
